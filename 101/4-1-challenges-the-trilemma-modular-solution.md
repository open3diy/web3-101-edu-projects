...
<img src="./assets/trilema.png" alt="trilema" width="350">
...
<img src="./assets/legoWeb3.png" alt="legoWeb3" width="350">
...
//todo explicar que todo se guia por protocolos, como eip o erc bip, al final son las normas para la composabilidad.
...
<img src="./assets/mundialPC.png" alt="mundialPC" width="350">
...
//todo frecuentemente descrita como "money legos" o "protocol legos" a la composabilidad
La característica definitoria de las DApps es la **composabilidad**, frecuentemente descrita como "money legos" o "protocol legos". A diferencia de aplicaciones Web2 donde cada servicio opera en silos aislados (no puedes usar tu cuenta de Instagram para publicar en YouTube, ni transferir tus compras de Amazon a eBay), en Web3 cualquier DApp puede integrar y componer protocolos existentes como bloques modulares e interoperables.
La característica definitoria de las DApps es la **composabilidad**, frecuentemente descrita como "money legos" o "protocol legos". A diferencia de aplicaciones Web2 donde cada servicio opera en silos aislados (no puedes usar tu cuenta de Instagram para publicar en YouTube, ni transferir tus compras de Amazon a eBay), en Web3 cualquier DApp puede integrar y componer protocolos existentes como bloques modulares e interoperables.

Por ejemplo, una DApp de gaming puede:

- Usar Uniswap para permitir que jugadores intercambien tokens in-game
- Integrar Aave para que jugadores stakeen sus recompensas y ganen yield
- Conectar con ENS para que usuarios tengan usernames legibles
- Utilizar IPFS para almacenar assets del juego de forma descentralizada
- Implementar Chainlink VRF para aleatoriedad verificable en mecánicas de juego
- Integrar Gitcoin Passport para verificar que jugadores son humanos únicos

Todo esto sin pedir permisos, firmar contratos, o integrar APIs propietarias. Los protocolos son públicos, permissionless y componibles por diseño. Esta arquitectura abierta acelera dramáticamente la innovación: developers no necesitan construir todo desde cero, sino que componen primitivas existentes de formas nuevas.
---
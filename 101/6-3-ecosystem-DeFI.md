...
<img src="./assets_5/DeFi.png" alt="ecosystem" width="400">
...
Bromas aparte... DeFi constituye la capa financiera del ecosistema Web3, orientada a crear y gestionar servicios como [préstamos](https://ethereum.org/es/defi/#lending), ahorro (mediante [staking](https://ethereum.org/es/staking/)), [intercambio](https://ethereum.org/es/defi/#swaps) de tokens o provisión de liquidez sin intermediarios (mediante [liquidity pools](https://finematics.com/liquidity-pools-explained/) usando un [AMM](https://academy.bit2me.com/que-es-automated-market-maker-amm/)). También se asocia con la búsqueda de beneficios ([Yield Farming](https://finematics.com/yield-farming-explained/) y su agregador [Yearn Finance](https://www.bitstamp.net/es/learn/cryptocurrency-guide/what-is-yearn-finance-yfi/)) y trading de derivados como los [sintéticos](https://www.bitstamp.net/es/learn/blockchain/what-are-synthetic-assets/). Su función principal es facilitar la financiación y el flujo de capital dentro del ecosistema.
...
- Intercambio gracias a la emisión y representación de [activos digitales](https://www.coinbase.com/es-es/learn/crypto-basics/what-are-digital-assets), mediante [stablecoins](https://academy.bit2me.com/que-es-stablecoin/), activos envueltos (como WBTC) y [activos tokenizados](https://www.reental.co/blog/que-es-la-tokenizacion-de-activos), que proporcionan liquidez y facilitan la interoperabilidad entre el ecosistema cripto y la economía real, además de incluir [derivados sintéticos](https://www.binance.com/es/square/post/24117748440802) y [tokens con rendimiento](https://bho.network/what-is-yield-bearing-token);
- Las [DAOs](https://www.coinbase.com/es-es/learn/crypto-basics/what-are-investment-daos-and-why-are-they-important-for-investors), que funcionan como estructuras de gobernanza y gestión de tesorería descentralizadas, análogas a fondos colectivos en el mundo tradicional.
...
Con el tiempo, y ante los desafíos regulatorios, dado que las ICO podían clasificarse como valores (securities), el proceso evolucionó hacia una estructura más robusta con la aparición de [launchpads](https://es.cointelegraph.com/news/launchpads-funding-ideas-not-products). Estas plataformas coordinan las ventas iniciales de tokens, incorporando mecanismos de cumplimiento y transparencia dentro del mercado primario. Son, en esencia, las ICO evolucionadas y mejor gestionadas: algunos operan con mecanismos centralizados y otros de forma descentralizada, pero todos actúan en la distribución inicial del token.

Con el tiempo, algunas de estas plataformas han evolucionado para también proporcionar acceso al [mercado secundario](https://es.wikipedia.org/wiki/Mercado_secundario). Los exchanges centralizados desarrollaron las [IEO](https://academy.bit2me.com/que-es-una-ieo/) (Initial Exchange Offering), donde la venta inicial ocurre directamente en el CEX, que luego ofrece trading continuo del token. Por su parte, el auge de DeFi llevó este modelo un paso más allá con las [IDO](https://academy.bit2me.com/como-participar-en-una-ido/) (Initial DEX Offerings), donde la distribución se ejecuta mediante contratos inteligentes descentralizados, eliminando intermediarios y optimizando la transparencia. Posteriormente surgieron variantes como las [IFO](https://academy.bit2me.com/en/what-is-an-ifo/) (Initial Farm Offering), orientadas a farming y yield desde el lanzamiento.

Es importante distinguir dos enfoques diferentes: por un lado, los launchpads puros (como DAO Maker o Polkastarter en sus inicios) se centran en el mercado primario y mantienen su espíritu de ayudar al emprendimiento, facilitando la venta inicial sin necesariamente gestionar pools de liquidez permanentes. Por otro lado, los launchpads híbridos o plataformas DeFi evolucionadas (como Polkastarter moderno o PancakeSwap con sus IFO) integran tanto el mercado primario como el secundario, combinando la venta inicial con pools de liquidez propias donde el token puede comerciarse inmediatamente. Este segundo enfoque suele verse más como un modelo de negocio integral que como una herramienta exclusiva de apoyo al emprendimiento.

Estos launchpads, sobre todo cuando son descentralizados o una evolución IDO, en contraste a las ICO tradicionales, pueden seguir un modelo [fair launch](https://www.coingecko.com/learn/what-is-a-fair-launch-in-crypto), que propone un enfoque radicalmente abierto: sin preminado, sin whitelists y sin fases privadas. Todos los participantes tienen acceso simultáneo desde el primer bloque, normalmente mediante minería, staking o liquidity mining. Este tipo de lanzamiento, más habitual en IDO, busca equidad total en la distribución, aunque sacrifica parte de la eficiencia en la recaudación inicial.
...
Sin activos digitales o criptoactivos como [stablecoins](https://www.coinbase.com/es-es/learn/crypto-basics/what-is-a-stablecoin) o [activos envueltos](https://www.binance.com/es/square/post/227457), etc ... DeFi quedaría limitado a su propio ecosistema: solo se podrían intercambiar activos nativos como ETH o tokens internos. Al tokenizar activos —ya sean BTC, bonos, acciones, materias primas o monedas fiduciarias (a través de stablecoins)— DeFi gana profundidad, liquidez y una conexión directa con la economía real.

Protocolos como [Synthetix](https://synthetix.io/) permiten crear activos sintéticos que replican cualquier activo del mundo real (acciones, commodities, fiat) mediante colateralización y oráculos. Synthetix utiliza un debt pool compartido donde todos los holders de synths comparten el riesgo colectivamente: cuando emites un sintético, asumes una deuda proporcional del pool global. Este mecanismo expande significativamente el alcance de DeFi más allá de las criptomonedas nativas, permitiendo exposición a activos tradicionales sin poseerlos directamente, pero introduce dependencia crítica de oráculos fiables y riesgo de desacople entre el precio sintético y el activo real.

El reto está en garantizar el colateral, la transparencia y las auditorías que respalden realmente el valor de los activos.

A cambio, proporciona liquidez y acceso abierto, sin permisos, a una economía verdaderamente global. Desde [WBTC](https://academy.bit2me.com/que-es-wrapped-bitcoin-wbtc/), que “envuelve” a Bitcoin, hasta cualquier otro [activo tokenizado](https://www.reental.co/blog/que-es-la-tokenizacion-de-activos), todo puede recibir liquidez; pero sin duda son las stablecoins las que ofrecen el anclaje más sólido al mundo real.

#### Las stablecoins: anclaje al mundo real

<img src="./assets_5/stablecoins.png" alt="ecosystem" width="400">
...
Las principales stablecoins del mercado son [USDT](https://academy.bit2me.com/que-es-usdt-theter-criptomoneda/) y [USDC](https://academy.bit2me.com/que-es-usdc/). USDT es la más utilizada y con mayor capitalización, aunque presenta menor transparencia sobre sus reservas. USDC, emitida por Circle, es la más regulada y auditada, lo que la hace más segura desde el punto de vista institucional. En EE.UU., con la [GENIUS Act de 2025](https://www.fundssociety.com/es/noticias/normativa/genius-act-asi-innova-ee-uu-para-innovar-en-el-ambito-de-las-stablecoins/), se ha despejado el camino, posicionándose claramente a favor de este ecosistema, incluso con normativa anti-CBDC, convirtiéndolas en una herramienta de política monetaria que le permite la financiación automática de su deuda pública. Esto se debe a que la ley exige que el respaldo 1:1 de estas monedas esté compuesto exclusivamente por activos ultra-seguros y líquidos de EE. UU., principalmente Bonos del Tesoro a corto plazo, asegurando que cada dólar en stablecoin aumente la demanda de deuda estadounidense.

En Europa, bajo la normativa [MiCA](https://academy.bit2me.com/cuales-son-las-stablecoins-ancladas-al-euro-y-adaptadas-a-mica/), las stablecoins deben ser emitidas por entidades reguladas dentro del Espacio Económico Europeo, por lo que el uso de versiones como [EURD](https://academy.bit2me.com/que-es-eurod/) será el camino natural. Sin embargo, al estar tan limitadas, está claro que la apuesta es por las [CBDC](https://www.bde.es/wbe/es/areas-actuacion/politica-monetaria/preguntas-frecuentes/definicion-funciones-del-dinero/que-son-las-cbdc.html), es decir, por monedas estables respaldadas por bancos europeos.

China impulsa el yuan digital o [e-CNY](https://www.binance.com/es-LA/square/post/16796254015674) como moneda digital soberana emitida por el Banco Popular, concebida para mantener el control directo sobre la oferta monetaria y la trazabilidad del sistema financiero (además de permitirle ajustar la liquidez o la deuda según sus políticas económicas). Sin embargo, no ha tenido la adopción deseada, mientras que soluciones como WeChat Pay o Alipay sí han funcionado. Paralelamente, Pekín utiliza a Hong Kong como laboratorio regulatorio para [experimentar con stablecoins privadas](https://es.cointelegraph.com/news/first-chinese-stablecoin-debut-race-heats-up) bajo supervisión, observando su adopción y efectos en los mercados internacionales sin comprometer la estabilidad ni el control financiero dentro del continente.

En el ámbito Web3, la stablecoin [DAI](https://academy.bit2me.com/que-es-dai/) de MakerDAO es una referencia porque es descentralizada y mantiene su valor mediante sobrecolateralización con criptoactivos. Aunque usa algoritmos para ajustar su paridad, no es una [stablecoin algorítmica](https://es.cointelegraph.com/learn/articles/stablecoins-101-what-are-crypto-stablecoins-and-how-do-they-work) pura, ya que está respaldada por activos reales bloqueados en contratos inteligentes.
...
Además de las grandes stablecoins como DAI o USDC, varios ecosistemas han intentado crear sus propias monedas estables nativas para mantener la liquidez dentro de su red y reducir la dependencia del dólar. Estos intentos muestran el interés de muchos protocolos en emitir una stablecoin propia que funcione como unidad de cuenta interna, aunque la mayoría han enfrentado problemas de estabilidad o de confianza en momentos de tensión del mercado. El caso mas sonada es el de [Terra y Luna](https://www.binance.com/es/square/post/19013579135442).
...
Las stablecoins, aunque aportan estabilidad y liquidez al ecosistema DeFi, también introducen riesgos sistémicos que pueden afectar tanto a protocolos individuales cuando forman parte de una pool de liquidez, como a todo el mercado de intercambio en general. Su aparente solidez depende de la transparencia de las reservas, la robustez del mecanismo de paridad y la confianza de los usuarios.

Un riesgo es el colateral, de transparencia, es decir, de conocimiento real sobre dónde están emitidas las reservas, qué cantidad total está en reserva, cuál está invertida en otros activos como en bonos del tesoro (en deuda pública) o instrumentos financieros de riesgo variable.

Otro riesgo es la calidad de los activos que respaldan la stablecoin o riesgo de paridad. En stablecoins centralizadas como USDT o USDC, un problema en las reservas o una congelación regulatoria puede provocar una pérdida de paridad inmediata como la de USDC en marzo de 2023 tras la quiebra de Silicon Valley Bank. En las descentralizadas como DAI, la caída del valor del colateral (por ejemplo ETH o wBTC) puede generar liquidaciones masivas que presionan la estabilidad del sistema.
...
[DAI](https://crypto.com/es/university/what-is-maker-dao-dai) es considerada por muchos la stablecoin nativa de la Web3 porque representa el ideal de descentralización funcional dentro del ecosistema DeFi: no depende de bancos, gobiernos ni empresas emisoras, sino de contratos inteligentes y gobernanza on-chain.

Su legitimidad viene de tres pilares:

- Se emite de forma abierta mediante colateral cripto (ETH, wBTC, LSDs, etc.).
- La política monetaria la define la comunidad a través de [MakerDAO](https://makerdao.com/es/).
...
Ejemplos destacados: [GMX](https://gmx.io/) (trading perpetuo con oráculos robustos y sin slippage para posiciones grandes), [dYdX](https://dydx.exchange/) (exchange de derivados descentralizado con orderbook off-chain y liquidación on-chain), [Frax Finance](https://frax.finance/) (stablecoins algorítmicas mejoradas que combinan colateral con mecanismos algorítmicos) y protocolos de Real World Assets (RWA) que tokenizan activos tradicionales.

Se centra en ofrecer servicios de agregación y orquestación [cross-chain](https://www.coinbase.com/es-es/learn/crypto-glossary/whats-the-difference-between-cross-chain-and-multichain) (pero no se considera [atomic swap](https://coinmarketcap.com/academy/es/glossary/atomic-swap)), es decir, reunir diferentes protocolos de DeFi 1.0 y 2.0 para ofrecer las mejores opciones, incluso entre distintas cadenas. Esto no ocurre únicamente dentro de una DApp, sino que también se ofrece como servicio especializado a través de agregadores y protocolos de abstracción de liquidez multi-chain. Por lo tanto, su interoperabilidad es su razón de ser: orquesta y agrega protocolos de las capas 1.0 y 2.0, moviendo capital dinámicamente entre diferentes redes para maximizar la eficiencia. Además, esta capa marca la integración de Activos del Mundo Real (RWA) como vía de escalabilidad, ampliando el alcance más allá del ecosistema puramente cripto. DeFi 3.0 permite nuevas oportunidades como Farming as a Service (FaaS), donde la orquestación cross-chain optimiza estrategias de yield farming a escala global.
...
Es importante distinguir entre **protocolos DeFi** (infraestructura reutilizable y composable) y **aplicaciones** que implementan esos protocolos. Esta diferencia es fundamental para comprender la naturaleza descentralizada y permissionless del ecosistema.

Por ejemplo:

- **Uniswap** es tanto un protocolo (contratos inteligentes que cualquiera puede usar) como una aplicación (interfaz web en app.uniswap.org). Otros desarrolladores pueden construir interfaces alternativas sobre el mismo protocolo sin pedir permiso.

- **DEXs centralizados como Binance** son aplicaciones, no protocolos: otros no pueden reutilizar su infraestructura de manera abierta.

Esta distinción es relevante porque los **protocolos verdaderamente descentralizados son permissionless y componibles**: cualquier desarrollador puede integrarlos sin pedir permiso, creando innovación sin necesidad de coordinación centralizada. Esta composabilidad es lo que permite que DeFi funcione como "money legos", donde cada pieza puede combinarse con otras para crear productos financieros cada vez más sofisticados.

Los protocolos definen las reglas y la lógica económica mediante contratos inteligentes auto-ejecutables, mientras que las aplicaciones son las interfaces que facilitan la interacción del usuario con esos protocolos. Un mismo protocolo puede tener múltiples aplicaciones o frontends construidos por diferentes equipos, cada uno ofreciendo su propia experiencia de usuario, pero todos operando sobre la misma infraestructura descentralizada.

## La economía: un entramado complejo y difícil de digerir

<img src="./assets_5/economyComplexity.png" alt="ecosystem" width="400">
...
<img src="./assets_5/web3Market.png" alt="ecosystem" width="400">
...
Los Yield Aggregators como Yearn Finance y Beefy Finance auto-componen las recompensas y cambian automáticamente entre estrategias según los rendimientos. Esto ahorra gas, permite estrategias profesionales y democratiza el acceso a farming avanzado. El usuario deposita capital y recibe un token representativo cuyo valor aumenta con el tiempo.
...
<img src="./assets_5/IDO-DeFI.png" alt="IDO" width="400">
...
DeFi opera en una zona gris regulatoria que varía drásticamente entre jurisdicciones. Aunque la descentralización reduce puntos de control, la realidad es que la regulación está llegando y afecta tanto a proyectos como a usuarios.

**Estados Unidos**: Con la [GENIUS Act de 2025](https://www.fundssociety.com/es/noticias/normativa/genius-act-asi-innova-ee-uu-para-innovar-en-el-ambito-de-las-stablecoins/), EE.UU. ha establecido un marco claro para stablecoins, exigiendo reservas 1:1 respaldadas por activos ultra-seguros (principalmente Bonos del Tesoro). Esto convierte a las stablecoins en un instrumento de política monetaria. Sin embargo, otros aspectos de DeFi (DEXs, lending, yield farming) aún carecen de claridad legal, lo que genera incertidumbre para proyectos y usuarios.

**Unión Europea**: La normativa [MiCA](https://academy.bit2me.com/cuales-son-las-stablecoins-ancladas-al-euro-y-adaptadas-a-mica/) (Markets in Crypto-Assets) regula la emisión de criptoactivos, incluyendo stablecoins, que deben ser emitidas por entidades reguladas en el EEE. Esto favorece soluciones como [EURD](https://academy.bit2me.com/que-es-eurod/) pero limita la innovación descentralizada. Europa también impulsa sus propias [CBDC](https://www.bde.es/wbe/es/areas-actuacion/politica-monetaria/preguntas-frecuentes/definicion-funciones-del-dinero/que-son-las-cbdc.html) (monedas digitales de bancos centrales), buscando control directo sobre la oferta monetaria digital.

**China**: Prohíbe el trading de criptomonedas pero impulsa el [yuan digital (e-CNY)](https://www.binance.com/es-LA/square/post/16796254015674), una CBDC controlada por el Banco Popular. Paralelamente, usa Hong Kong como laboratorio para [experimentar con stablecoins privadas](https://es.cointelegraph.com/news/first-chinese-stablecoin-debut-race-heats-up) bajo supervisión estricta.

**Implicaciones para emprendedores**: Conocer el marco regulatorio de tu jurisdicción es crítico. Aspectos como KYC/AML, obligaciones fiscales (reporting de yields, staking, airdrops), restricciones geográficas y cumplimiento de securities laws pueden determinar la viabilidad legal de un proyecto. Ignorar estos aspectos puede llevar a sanciones, bloqueos de fondos o incluso acciones penales.

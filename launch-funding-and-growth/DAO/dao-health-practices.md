...
> Este documento trata de mantener el equilibrio entre los tres factores que sostienen una DAO: utilidad real del protocolo, incentivos que motivan la participación hoy, y proyección a largo plazo. No describe cómo funcionan los mecanismos financieros —eso está en [treasury-management.md](treasury-management.md)— ni cómo se estructura la gobernanza formal —eso está en [governance-architecture.md](governance-architecture.md)—. Este documento responde a una pregunta diferente: ¿cómo sabes que algo va mal antes de que sea demasiado tarde para reaccionar?

...
Igualmente tenemos que entender que una DAO se guía [por las ciencias políticas](#las-daos-y-la-ciencia-política) más que por la gestión empresarial, porque realmente es un colectivo con el que tenemos que negociar. Pensar en una DAO como una empresa descentralizada es, de hecho, la comparación equivocada: se parece más a un mini estado-nación digital, un colectivo que se dota de sus propias normas (los estatutos que veremos más adelante), de un protocolo que las ejecuta sin intermediarios, y de un sistema económico propio —tesorería, token, incentivos— para sostenerse en el tiempo, igual que una nación se sostiene con su constitución, sus instituciones y su moneda. No nos engañemos: aunque muchas DAOs esperan que el protocolo tenga rendimiento económico, el ámbito descentralizado hace que tratarlas como un gobierno sea más óptimo que como una empresa. Si tu proyecto necesita velocidad de ejecución centralizada, probablemente no deberías crear una DAO: lo que buscas es una empresa tradicional.
...
Las DAOs emergen del impulso humano por organizarse en comunidades para perseguir objetivos compartidos. En estos entornos, el efecto red asegura que cuanto mayor sea la participación, mayor será el valor generado. Una DAO habilita la gobernanza descentralizada de esa red: emplea tecnología blockchain y [tokens de gobernanza](5-2-crypto-asset-taxonomy.md#clasificación-regulatoria-y-normativa) para coordinar a los miembros de manera transparente, eficiente y sin jerarquías tradicionales.

Visto así, una DAO es ante todo una red de participantes que necesita un modelo de gobernanza para coordinarse, igual que cualquier red humana necesita reglas para decidir. Esa red no tiene por qué ser abierta a cualquiera: puede ser pública y *permissionless*, donde cualquiera con el token entra, propone y vota sin pedir permiso, o puede ser permisionada, con acceso restringido a miembros verificados o invitados, como ocurre en consorcios empresariales, DAOs que gestionan activos regulados o redes privadas entre instituciones. Lo que define a la DAO no es el grado de apertura de su red, sino que existan personas organizadas gobernándola según reglas explícitas y ejecutables.
...
Esto explica por qué conceptos de la ciencia política resultan más útiles que los organigramas tradicionales. La separación de poderes no es teoría: es separar quién propone código (core developers), quién vota (token holders) y quién audita la ejecución (comités de seguridad). Y el dictador temporal romano se convierte en los multisigs de emergencia: un grupo pequeño que puede pausar contratos ante un ataque, pero cuyo poder expira después de la crisis.

Pero el concepto que mejor encaja con una DAO no es la democracia representativa clásica, sino la democracia líquida: un modelo intermedio entre votar directamente cada propuesta y delegar de forma permanente en un representante. En una democracia representativa tradicional eliges a alguien para un período fijo y sobre todos los temas por igual; en una democracia líquida puedes votar tú mismo cuando te interesa, delegar tu voto en otra persona cuando no tienes tiempo o criterio, cambiar esa delegación en cualquier momento sin esperar a una nueva elección, e incluso delegar de forma distinta según el tema, confiando en un especialista en riesgo financiero para propuestas de colateral pero votando directamente cuando se discuten los valores de la comunidad. Este modelo es casi imposible de operar a escala nacional con papeletas de papel y censos electorales, pero es trivial cuando el voto y la delegación viven en un contrato o en una plataforma como Snapshot: revocar o reasignar poder de voto es una transacción, no un proceso burocrático. Por eso las DAOs no solo pueden implementar democracia líquida, sino que son el entorno donde este modelo despliega todo su potencial: es el mismo mecanismo de delegación que vimos en la [Fase 4 del proceso de inmersión](#fase-4-delegar-si-no-tienes-tiempo).

En este sentido, una DAO se parece más a un mini estado-nación que a una empresa: un colectivo que se dota de normas propias, de un protocolo que las ejecuta, y de un sistema económico propio para sostenerse sin depender de una jurisdicción externa. Diseñar una DAO no es diseñar una startup con votaciones. Es diseñar un sistema político que debe sostenerse sin ayuda externa.
